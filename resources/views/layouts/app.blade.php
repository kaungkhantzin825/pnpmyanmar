            ...
            <div class="flex justify-between items-center h-20">
                        ...
                        <div class="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-xl border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                            ...
                            @auth
                                @if(auth()->user()->role === 'admin')
                                    <a href="{{ route('admin.dashboard') }}" class="block px-4 py-3 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-b-lg">Admin Panel</a>
                                @endif
                            @endauth
                ...
                <div class="flex items-center space-x-3 flex-shrink-0">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="btn-3d btn-3d-cyan">
                            Register
                        </a>
                    @endauth
                </div>
